...
export interface DashboardDepensePoint {
  date: string;
  montant: number;
}
...
@Component({
  standalone: true,
  selector: 'budget19-dashboard-depense-chart',
  templateUrl: './dashboard-depense-chart.component.html',
  styleUrls: ['./dashboard-depense-chart.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush,
  imports: [CommonModule, NgChartsModule],
})
export class DashboardDepenseChartComponent implements OnChanges {
  @Input({ required: true }) data: DashboardDepensePoint[] = [];
  ...
  private aggregateAndSortData(data: DashboardDepensePoint[]): DashboardDepensePoint[] {
